...
` +
    ...
    var qn = Dn(
      ...
      j = Dn(h({}, On, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Xn = Dn(
        h({}, Fn, {
          deltaX: function (e) {
            return `deltaX` in e
...
function ce(e, t, n, r, i) {
  let a = we((typeof t == `string` ? ie(t) : t).pathname || `/`, n);
...
function ve(e, t) {
  ...
  return (
    ...
    n
      .filter((e) => !_e(e))
      .reduce((e, t) => e + (fe.test(t) ? pe : t === `` ? me : he), r)
  );
}
function ye(e, t) {
  ...
  for (let e = 0; e < r.length; ++e) {
    ...
    (Object.assign(i, u.params),
      o.push({
        ...
        pathnameBase: Fe(Ne([a, u.pathnameBase])),
        route: d,
      }),
...
function Be(e) {
  return Ne(e.map((e) => e.route.path).filter(Boolean)) || `/`;
}
var Ve =
  typeof window < `u` &&
  window.document !== void 0 &&
...
var Ye = x.createContext({ isTransitioning: !1 });
Ye.displayName = `ViewTransition`;
var Xe = x.createContext(new Map());
...
function st(e, { relative: t } = {}) {
  ...
  let { basename: n, navigator: r } = x.useContext(Qe),
...
function pt() {
  ...
  let e = x.useContext(Ge),
    { basename: t, navigator: n } = x.useContext(Qe),
...
function gt(e, t, n) {
  ...
  let { navigator: r } = x.useContext(Qe),
    { matches: i } = x.useContext(et),
    a = i[i.length - 1],
    o = a ? a.params : {},
    s = a ? a.pathname : `/`,
    c = a ? a.pathnameBase : `/`,
...
var vt = x.createElement(_t, null),
  yt = class extends x.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e === void 0
          ...
          : x.createElement(
              ...
              x.createElement(tt.Provider, {
                value: e,
                children: this.props.component,
              }),
            );
      return this.context ? x.createElement(xt, { error: e }, t) : t;
    }
  };
yt.contextType = qe;
var bt = new WeakMap();
function xt({ children: e, error: t }) {
  let { basename: n } = x.useContext(Qe);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
  ...
  return (
    ...
    h == null
      ...
      : x.createElement(
          Qe.Provider,
          { value: c },
          x.createElement($e.Provider, { children: t, value: h }),
        )
  );
}
  ...
  return (
    n
      ...
      : i.pathname === `/`
        ? (i.pathname = `_root.${r}`)
        : t && we(i.pathname, t) === `/`
          ? (i.pathname = `${Pe(t)}/_root.${r}`)
          : (i.pathname = `${Pe(i.pathname)}.${r}`),
    i
  );
}
...
var gn = x.createContext(void 0);
gn.displayName = `FrameworkContext`;
function _n() {
  let e = x.useContext(gn);
  return (
    nn(e, `You must render this element inside a <HydratedRouter> element`),
    e
  );
}
function vn(e, t) {
  let n = x.useContext(gn),
    [r, i] = x.useState(!1),
    [a, o] = x.useState(!1),
    {
      onFocus: s,
...
function bn({ page: e, ...t }) {
  ...
  return i
    ? n
      ...
      : x.createElement(Cn, { page: e, matches: i, ...t })
    : null;
}
function xn(e) {
...
function Sn({ page: e, matches: t, ...n }) {
  let r = lt(),
    ...
    o = x.useMemo(() => {
      ...
      let n = rn(e, a, i.unstable_trailingSlashAwareDataRequests, `rsc`),
        o = !1,
        s = [];
      for (let e of t)
...
function Cn({ page: e, matches: t, ...n }) {
  let r = lt(),
    ...
    u = x.useMemo(() => ln(e, t, l, a, r, `data`), [e, t, l, a, r]),
    d = x.useMemo(() => ln(e, t, l, a, r, `assets`), [e, t, l, a, r]),
    f = x.useMemo(() => {
      if (e === r.pathname + r.search + r.hash) return [];
      let n = new Set(),
        l = !1;
      if (
        ...
        return [];
      let d = rn(e, s, i.unstable_trailingSlashAwareDataRequests, `data`);
      return (
        l &&
          n.size > 0 &&
          d.searchParams.set(
...
var Tn =
  ...
  window.document.createElement !== void 0;
try {
  Tn && (window.__reactRouterVersion = `7.15.1`);
} catch {}
...
var On = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  kn = x.forwardRef(function (
    ...
    let { basename: h, navigator: g, useTransitions: _ } = x.useContext(Qe),
      v = typeof l == `string` && On.test(l),
      y = He(l, h);
    l = y.to;
    let b = st(l, { relative: r }),
      ee = lt(),
      S = null;
    if (o) {
      let e = je(o, [], ee.mask ? ee.mask.pathname : `/`, !0);
      (h !== `/` && (e.pathname = e.pathname === `/` ? h : Ne([h, e.pathname])),
        (S = g.createHref(e)));
    }
    let [C, w, T] = vn(n, p),
      te = In(l, {
    ...
    return C && !v
      ? x.createElement(x.Fragment, null, re, x.createElement(bn, { page: b }))
      : re;
  });
kn.displayName = `Link`;
var An = x.forwardRef(function (
  ...
  let u = mt(a, { relative: c.relative }),
    d = lt(),
    f = x.useContext(Ke),
    { navigator: p, basename: m } = x.useContext(Qe),
    h = f != null && Kn(u) && o === !0,
...
var jn = x.forwardRef(
  (
    ...
    let { useTransitions: h } = x.useContext(Qe),
      g = zn(),
      _ = Bn(s, { relative: l }),
...
function Mn({ getKey: e, storageKey: t, ...n }) {
  let r = x.useContext(gn),
    { basename: i } = x.useContext(Qe),
    a = lt(),
    o = At();
  ...
  return x.createElement(`script`, {
    ...
    dangerouslySetInnerHTML: {
      __html: `(${c})(${tn(JSON.stringify(t || Vn))}, ${tn(JSON.stringify(s))})`,
    },
  });
}
...
function Xn() {
  ...
  return (0, j.jsxs)(`nav`, {
    className: `shuunav`,
    children: [
      (0, j.jsx)(kn, { className: `shuulogo`, to: `/`, children: `宗` }),
      (0, j.jsxs)(`ul`, {
        className: `shuunav-links${e ? ` open` : ``}`,
        children: [
          (0, j.jsx)(`li`, {
            children: (0, j.jsx)(An, {
              to: `/about`,
      ...
      (0, j.jsx)(`button`, {
        className: `shuunav-lang`,
        type: `button`,
        children: `EN / JP`,
      }),
      (0, j.jsxs)(`button`, {
        className: `shuuhamburger${e ? ` active` : ``}`,
        type: `button`,
        onClick: () => t(!e),
...
function Zn() {
  return (0, j.jsxs)(`footer`, {
    className: `shuufooter`,
    children: [
      (0, j.jsx)(`div`, {
        className: `shuufooter-logo`,
        children: `宗株式会社`,
      }),
      (0, j.jsx)(`p`, {
        className: `shuufooter-copy`,
        children: `© 2024 Shuu Corporation. All rights reserved.`,
      }),
    ],
  });
}
function Qn() {
  return (0, j.jsxs)(`div`, {
    ...
    children: [
        ...
        children: [
          (0, j.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, j.jsx)(`p`, {
                className: `shuutitle-jp`,
                children: `デジタルの力で、日本の価値をヨーロッパへ。`,
              }),
              (0, j.jsx)(`p`, {
                className: `shuudesc`,
                children: `デジタルマーケティングと骨董・アンティークの越境取引を通じて、日本とヨーロッパを繋ぐ新しいビジネスを創出します。`,
              }),
              (0, j.jsx)(kn, {
                className: `shuucta`,
                to: `/service`,
          ...
          (0, j.jsxs)(`div`, {
            className: `shuuhero-right`,
            children: [
              (0, j.jsx)(`div`, { className: `shuukanji`, children: `宗` }),
              (0, j.jsxs)(`div`, {
                className: `shuustats`,
                children: [
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      (0, j.jsx)(`div`, {
                        className: `shuustat-num`,
                        children: `Curate`,
                      }),
                      (0, j.jsx)(`div`, {
                        className: `shuustat-label`,
                        children: `目利き・厳選`,
                      }),
                    ],
                  }),
      ...
      (0, j.jsxs)(`section`, {
        className: `shuuservices`,
        children: [
          (0, j.jsx)(`p`, {
            className: `shuusection-label`,
          ...
          (0, j.jsxs)(`div`, {
            ...
            children: [
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsx)(`p`, {
                    className: `shuucard-num`,
                    children: `01`,
                  }),
                  (0, j.jsxs)(`h2`, {
                    className: `shuucard-en`,
                    children: [`Digital`, (0, j.jsx)(`br`, {}), `Marketing`],
                  }),
                  (0, j.jsx)(`p`, {
                    className: `shuucard-jp`,
                    children: `デジタルマーケティング支援`,
                  }),
                  (0, j.jsx)(`p`, {
                    className: `shuucard-desc`,
                    children: `SEO・広告運用・SNSマーケティングを中心に、法人向けのデジタル集客を支援します。自社での実践から得たノウハウを、クライアントの成長に還元します。`,
                  }),
                  (0, j.jsx)(kn, {
                    className: `shuucard-link`,
                    to: `/service`,
                    children: `詳しく見る →`,
                  }),
                ],
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`p`, {
                    className: `shuucard-jp`,
                    children: `骨董・アンティーク越境取引`,
                  }),
                  (0, j.jsx)(`p`, {
                    className: `shuucard-desc`,
                    children: `日本国内で厳選した骨董・アンティーク品を、ヨーロッパの市場へ届けます。古物商免許のもと、確かな目利きと誠実な取引を大切にしています。`,
                  }),
                  (0, j.jsx)(kn, {
                    className: `shuucard-link`,
                    to: `/service`,
      ...
      (0, j.jsxs)(`section`, {
        className: `shuuphilosophy`,
        children: [
          (0, j.jsx)(`p`, {
            className: `shuuphil-label`,
            children: `Our Philosophy`,
          }),
          (0, j.jsxs)(`div`, {
            children: [
              (0, j.jsxs)(`p`, {
                className: `shuuphil-quote`,
                children: [
              ...
              (0, j.jsx)(`p`, {
                className: `shuuphil-sub`,
                children: `自らも市場に立ち、デジタルで販路を開く。その実践から生まれた知見を、クライアントへの支援に活かしています。`,
              }),
            ],
          }),
        ],
...
function $n() {
  return (0, j.jsxs)(`div`, {
    ...
    children: [
      (0, j.jsxs)(`div`, {
        className: `shuupage-header`,
        children: [
          (0, j.jsxs)(`div`, {
            children: [
              (0, j.jsx)(`p`, {
                className: `shuupage-eyebrow`,
                children: `Our Services`,
              }),
              (0, j.jsxs)(`h1`, {
                className: `shuupage-title`,
                children: [`What`, (0, j.jsx)(`br`, {}), `We Do.`],
              }),
              (0, j.jsx)(`p`, {
                className: `shuupage-title-jp`,
                children: `事業内容`,
              }),
            ],
          }),
          (0, j.jsxs)(`p`, {
            className: `shuupage-lead`,
            children: [
      ...
      (0, j.jsxs)(`div`, {
        className: `shuuservice-block`,
        children: [
          (0, j.jsxs)(`div`, {
            className: `shuuservice-info`,
            children: [
              (0, j.jsx)(`p`, {
                className: `shuuservice-num`,
                children: `01 — Digital Marketing`,
              }),
              (0, j.jsxs)(`h2`, {
              ...
              (0, j.jsx)(`p`, {
                className: `shuuservice-body`,
                children: `法人向けのデジタル集客支援を行います。SEOから広告運用、SNSマーケティングまで、自社での実践から得た知見をもとに、クライアントの成長を支えます。`,
              }),
              (0, j.jsxs)(`div`, {
                className: `shuuitems`,
                children: [
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `SEO対策・コンテンツマーケティング`,
                  }),
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `リスティング・SNS広告運用`,
                  }),
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `SNSアカウント運用支援`,
                  }),
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `アクセス解析・改善提案`,
                  }),
                ],
              }),
              (0, j.jsx)(kn, {
                className: `shuuservice-cta`,
                to: `/contact`,
                children: `お問い合わせ →`,
              }),
            ],
          ...
          (0, j.jsxs)(`div`, {
            className: `shuuservice-visual`,
            children: [
              (0, j.jsx)(`p`, {
                className: `shuuvisual-label`,
                children: `Service 01`,
              }),
              (0, j.jsxs)(`div`, {
                className: `shuuflow`,
                children: [
                  (0, j.jsxs)(`div`, {
                    className: `shuuflow-step`,
                    children: [
                      (0, j.jsx)(`span`, {
                        className: `shuuflow-step-label`,
                        children: `現状分析・戦略立案`,
                      }),
                      (0, j.jsx)(`span`, {
                        className: `shuuflow-step-num`,
                        children: `Step 01`,
                      }),
                    ],
                  }),
      ...
      (0, j.jsxs)(`div`, {
        className: `shuuservice-block reverse`,
        children: [
          (0, j.jsxs)(`div`, {
            className: `shuuservice-info`,
            children: [
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `日本国内での仕入れ・買取`,
                  }),
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `真贋・状態の査定・管理`,
                  }),
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `ヨーロッパへの輸出・販売`,
                  }),
                  (0, j.jsx)(`div`, {
                    className: `shuuitem`,
                    children: `バイヤー・パートナー企業との連携`,
                  }),
                ],
              }),
              (0, j.jsx)(kn, {
      ...
      (0, j.jsxs)(`div`, {
        className: `shuubridge`,
        children: [
          (0, j.jsx)(`p`, {
            className: `shuubridge-label`,
            children: `Our Philosophy`,
          }),
          (0, j.jsxs)(`div`, {
            children: [
              (0, j.jsxs)(`p`, {
                className: `shuubridge-text`,
                children: [
                  `"We don't just advise —`,
                  (0, j.jsx)(`br`, {}),
                  `we practice what we preach."`,
        ...
        children: [
          (0, j.jsxs)(`div`, {
            children: [
              ...
              (0, j.jsxs)(`h1`, {
                className: `shuupage-title`,
                children: [`Who`, (0, j.jsx)(`br`, {}), `We Are.`],
              }),
              (0, j.jsx)(`p`, {
                className: `shuupage-title-jp`,
                children: `会社概要`,
          ...
          (0, j.jsx)(`p`, {
            className: `shuupage-lead`,
            children: `大阪を拠点に、デジタルマーケティングと骨董・アンティークの越境取引を手がける会社です。日本とヨーロッパを繋ぐ架け橋として、誠実な取引と実践知を大切にしています。`,
          }),
        ],
      }),
      (0, j.jsxs)(`div`, {
        className: `shuuinfo-section`,
        children: [
          (0, j.jsxs)(`div`, {
            className: `shuuinfo-left`,
            children: [
              (0, j.jsx)(`p`, {
                className: `shuusection-label`,
              ...
              (0, j.jsx)(`table`, {
                ...
                children: (0, j.jsxs)(`tbody`, {
                  children: [
                    (0, j.jsxs)(`tr`, {
                      children: [
                        (0, j.jsx)(`td`, { children: `Company` }),
                        (0, j.jsxs)(`td`, {
                          children: [
                            `宗株式会社`,
                            (0, j.jsx)(`br`, {}),
                            (0, j.jsx)(`span`, {
                              className: `shuumuted-en`,
                              children: `Shuu Corporation`,
                            }),
                          ],
                        }),
                      ],
                    ...
                    (0, j.jsxs)(`tr`, {
                      children: [
                        (0, j.jsx)(`td`, { children: `Founded` }),
                        (0, j.jsx)(`td`, { children: `2024年` }),
                      ],
                    }),
                    (0, j.jsxs)(`tr`, {
                      children: [
                        (0, j.jsx)(`td`, { children: `Location` }),
                        (0, j.jsxs)(`td`, {
                          children: [
                            `大阪府大阪市`,
                            (0, j.jsx)(`br`, {}),
                    ...
                    (0, j.jsxs)(`tr`, {
                      children: [
                        (0, j.jsx)(`td`, { children: `License` }),
                        (0, j.jsx)(`td`, {
                          children: `古物商許可証（大阪府公安委員会）`,
                        }),
                      ],
                    }),
                  ],
              ...
              (0, j.jsxs)(`div`, {
                className: `shuulicense`,
                children: [
                  (0, j.jsx)(`p`, {
                    className: `shuulicense-label`,
                    children: `古物商許可証番号`,
                  }),
                  (0, j.jsx)(`p`, {
                    className: `shuulicense-num`,
                    children: `第 〇〇〇〇〇〇〇〇〇〇〇 号`,
                  }),
                  (0, j.jsx)(`p`, {
                    className: `shuulicense-sub`,
                    children: `大阪府公安委員会許可`,
                  }),
                ],
              }),
          ...
          (0, j.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, j.jsxs)(`div`, {
                className: `shuuaccess-items`,
                children: [
                  (0, j.jsxs)(`div`, {
                    className: `shuuaccess-item`,
                    children: [
                      (0, j.jsx)(`p`, {
                        className: `shuuaccess-item-label`,
                        children: `Address`,
                      }),
                      (0, j.jsx)(`p`, {
                        className: `shuuaccess-item-val`,
                        children: `大阪府大阪市●●区●●●●`,
                      }),
                      (0, j.jsx)(`p`, {
                        className: `shuuaccess-item-en`,
                        children: `Osaka, Japan`,
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`p`, {
                        className: `shuuaccess-item-val`,
                        children: `info@shuu-corporation.co.jp`,
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`p`, {
                        className: `shuuaccess-item-val`,
                        children: `平日 10:00 — 18:00`,
                      }),
                      (0, j.jsx)(`p`, {
                        className: `shuuaccess-item-en`,
                        children: `Mon – Fri, 10:00 – 18:00 JST`,
                      }),
                    ],
                  }),
                ],
        ...
        children: [
          (0, j.jsxs)(`div`, {
            children: [
              ...
              (0, j.jsxs)(`h1`, {
                className: `shuupage-title`,
                children: [`Get in`, (0, j.jsx)(`br`, {}), `Touch.`],
              }),
              (0, j.jsx)(`p`, {
                className: `shuupage-title-jp`,
                children: `お問い合わせ`,
          ...
          (0, j.jsx)(`p`, {
            className: `shuupage-lead`,
            children: `デジタルマーケティング支援のご相談、骨董・アンティーク品の買取・取引に関するお問い合わせは、こちらからお気軽にご連絡ください。日本語・英語にて対応いたします。`,
          }),
        ],
      }),
      (0, j.jsxs)(`div`, {
        className: `shuucontact-body`,
        children: [
          (0, j.jsxs)(`div`, {
            className: `shuuform-area`,
            children: [
              (0, j.jsx)(`p`, {
                className: `shuusection-label`,
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`div`, {
                    className: `shuufield-label`,
                    children: [
                      (0, j.jsx)(`span`, { children: `お名前 / Name` }),
                      (0, j.jsx)(`span`, {
                        className: `shuurequired`,
                        children: `Required`,
                      }),
                    ],
                  }),
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`div`, {
                    className: `shuufield-label`,
                    children: [
                      (0, j.jsx)(`span`, { children: `会社名 / Company` }),
                      (0, j.jsx)(`span`, {
                        className: `shuurequired`,
                        children: `Optional`,
                      }),
              ...
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      (0, j.jsx)(`span`, {
                        children: `お問い合わせ種別 / Inquiry Type`,
                      }),
                      (0, j.jsx)(`span`, {
                        className: `shuurequired`,
                        children: `Required`,
                  ...
                  (0, j.jsx)(`div`, {
                    className: `shuuselect-wrap`,
                    children: (0, j.jsxs)(`select`, {
                      className: `shuuselect`,
                      defaultValue: ``,
                      children: [
                        (0, j.jsx)(`option`, {
                          value: ``,
                          children: `選択してください / Please select`,
                        }),
                        (0, j.jsx)(`option`, {
                          children: `デジタルマーケティング支援について`,
                        }),
                        (0, j.jsx)(`option`, {
                          children: `骨董・アンティーク品の買取について`,
                        }),
                        (0, j.jsx)(`option`, {
                          children: `骨董・アンティーク品の購入について`,
                        }),
                        (0, j.jsx)(`option`, {
                          children: `パートナーシップについて`,
                        }),
                        (0, j.jsx)(`option`, { children: `その他 / Other` }),
                      ],
                    }),
                  }),
                ],
...
Please describe your inquiry.`,
              ...
              (0, j.jsx)(`button`, {
                className: `shuusubmit`,
                type: `button`,
                children: `Send Message — 送信する`,
              }),
              (0, j.jsxs)(`p`, {
                className: `shuuform-note`,
                children: [
                  `送信後、3営業日以内にご返信いたします。`,
                  (0, j.jsx)(`br`, {}),
          ...
          (0, j.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, j.jsxs)(`div`, {
                className: `shuucontact-items`,
                children: [
                  (0, j.jsxs)(`div`, {
                    className: `shuucontact-item`,
                    children: [
                      (0, j.jsx)(`span`, {
                        className: `shuucontact-item-label`,
                        children: `Email`,
                      }),
                      (0, j.jsx)(`span`, {
                        className: `shuucontact-item-val`,
                        children: `info@shuu-corporation.co.jp`,
                      }),
                    ],
                  }),
              ...
              (0, j.jsxs)(`div`, {
                className: `shuulang-note`,
                children: [
                  (0, j.jsx)(`p`, {
                    className: `shuulang-note-label`,
                    children: `Languages`,
                  }),
                  (0, j.jsxs)(`p`, {
                    className: `shuulang-note-text`,
                    children: [
...
function nr() {
  return (0, j.jsxs)(En, {
    children: [
      ...
      (0, j.jsxs)(Rt, {
        children: [
          (0, j.jsx)(It, { path: `/`, element: (0, j.jsx)(Qn, {}) }),
          (0, j.jsx)(It, { path: `/service`, element: (0, j.jsx)($n, {}) }),
          (0, j.jsx)(It, { path: `/about`, element: (0, j.jsx)(er, {}) }),
          (0, j.jsx)(It, { path: `/contact`, element: (0, j.jsx)(tr, {}) }),
        ],
      }),
    ],
  });
}
Yn.createRoot(document.getElementById(`root`)).render(
  (0, j.jsx)(x.StrictMode, { children: (0, j.jsx)(nr, {}) }),
);
